// ============================================
// Register Page — Mobile-First Account Creation
// ============================================
      ...
      <div className="w-full max-w-md animate-fade-in">
        ...
        <div className="text-center mb-6">
          ...
          <p className="text-surface-400 text-sm">
            Join YurDeals — shop from China, delivered to Nigeria
          </p>
        </div>
        ...
        <div className="rounded-2xl bg-white/[0.07] backdrop-blur-xl border border-white/10 p-6 sm:p-8">
          ...
          <form onSubmit={handleSubmit} noValidate className="space-y-4">
            ...
            <div>
              ...
              />
              {fieldErrors.name && (
                <p id="register-name-error" className="mt-1 text-xs text-red-400" role="alert">
                  {fieldErrors.name}
                </p>
              )}
            </div>
